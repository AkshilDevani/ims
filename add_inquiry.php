...
//   session_start();
  ...
  // include 'db.php';
  $con = mysqli_connect("localhost","root","","imsmangment");
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Inquiry Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form method="post" enctype="multipart/form-data" id="frm">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="inquiry_name" id="exampleInputEmail1" placeholder="Enter Name" value="<?php echo @$data['inquiry_name'] ?>">
                  </div>
                   <div class="form-group">
                    <label for="exampleInputEmail1">Contact</label>
                    <input type="text" class="form-control" name="contact" id="contact" placeholder="Enter contact" value="<?php echo @$data['contact'] ?>">
                    <span style="color: red; display: none;">Enter Indian Fromate...!</span>
                  </div>

                <div class="form-group">
                  <label>Course</label>
                  <select class="select2" multiple="multiple" data-placeholder="Select course" style="width: 100%;" name="course[]">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="detail" id="exampleInputEmail1" placeholder="Enter Detail" value="<?php echo @$data['detail'] ?>">
                  </div>
                   <div class="form-group">
                    <label for="exampleInputEmail1">Join Date</label>
                    <input type="date" class="form-control" name="join_date" id="exampleInputEmail1" placeholder="Enter Join Date" value="<?php echo @$data['join_date'] ?>">
                  </div>

                   <div class="form-group">
                    <label for="exampleInputPassword1">Refernce Name</label>
                    <select class="form-control" name="ref_id" value="<?php echo @$data['ref_name'] ?>">
                      <option selected="" disabled>--Select Refernce Name--</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ref_reason" id="exampleInputEmail1" placeholder="Enter Reason" value="<?php echo @$data['ref_reason'] ?>">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="status">
                      <?php  $sql_select_admin = "select * from status";
                        $admin_data1 = mysqli_query($con,$sql_select_admin); ?>
                      <option selected="" disabled>--Select Inquiryby--</option>
                      <?php while($row = mysqli_fetch_assoc($admin_data1)) { ?>
                        <option value="<?php echo $row['id']; ?>" <?php if ($row['id'] == $userid) echo "selected"; ?>><?php echo $row['status_name']; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  </div>
...
<script>
  ...
  $(document).ready(function()
  {
      $('#frm').submit(function() 
      {
        ...
        var c_contact =  /((\+)((0[ -]+)|(91 ))(\d{12}|\d{10}))|\d{5}([- ])\d{6}/;
