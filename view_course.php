          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mt-3">
                  <a class="btn btn-primary btn-sm" href="view_course.php?page=1">All</a>    
<?php
                  if($page>1)
                  {
                        echo "<a href='view_course.php?page=".$page - 1 ."' class='btn btn-primary btn-sm' >pre</a>";

                  }
                  for ($i=1; $i<=$total_page; $i++)
                  {  
?>
                    <a class="btn btn-primary btn-sm" href="view_course.php?page=<?php echo $i; if(isset($_GET['search'])) {?> &search=<?php  echo $_GET['search']; } ?>"><?php echo $i; ?></a>    
<?php     
                  } 
                  if($page<=$total_page-1)
                  {
                        echo "<a href='view_course.php?page=".$page +1 ."' class='btn btn-primary btn-sm' >next</a>";
